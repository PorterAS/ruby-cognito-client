...
module Cognito
  class Container
    ...
    namespace :operations do
      ...
      register :reset_password,         callable { Cognito::Operations::ResetPassword.new }
      register :confirm_reset_password, callable { Cognito::Operations::ConfirmResetPassword.new }
    end
  end
...
require 'cognito/operations/reset_password'
require 'cognito/operations/confirm_reset_password'
